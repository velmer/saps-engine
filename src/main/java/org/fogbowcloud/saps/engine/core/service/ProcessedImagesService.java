...
public class ProcessedImagesService {
    ...
    /**
     * Generates a {@link ImageTaskFile} object for every file generated by the
     * processing of {@link ImageTask} that had its ID specified.
     *
     * @param properties  Properties that contains Object Store information.
     * @param imageTaskId ImageTask's ID.
     * @return List of {@link ImageTaskFile}.
     */
    public static List<ImageTaskFile> generateImageTaskFiles(Properties properties, String imageTaskId) {
        List<String> filesPaths = ObjectStoreService.getImageTaskFilesPaths(properties, imageTaskId);
