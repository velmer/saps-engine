...
public class ImagesEmailResource extends BaseResource {
    ...
    private static final String SUCCESSFUL_EMAIL_SENDING_FEEDBACK = "Email será enviado em breve.";
    private static final String UNSUCCESSFUL_EMAIL_SENDING_FEEDBACK = "Houve um erro ao enviar o email, tente novamente.";
    ...
    private List<ImageTaskFileList> getImageTasksFilesFromSAPSNeighbor(
        ...
        try {
            ...
            addImageTasksIdsToHeader(clientResource, imageTasksIds);
    ...
    /**
     * Adds the specified list of IDs of ImageTasks to header of specified
     * {@link ClientResource}.
     *
     * @param clientResource Client Resource to have a header added.
     * @param imageTasksIds  List of IDs of ImageTasks to be added to header.
     */
    @SuppressWarnings("unchecked")
    private void addImageTasksIdsToHeader(ClientResource clientResource, List<String> imageTasksIds) {
        Series<Header> headers = (Series<Header>) clientResource.getRequestAttributes()
                .get(RESTLET_HTTP_HEADERS);
        if (headers == null) {
            headers = new Series<>(Header.class);
        }
        // TODO: Verify if sending the toString of array will work
        headers.add(REQUEST_ATTR_PROCESSED_IMAGES, imageTasksIds.toString());
    }
